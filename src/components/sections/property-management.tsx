...
export function PropertyManagement() {
  return (
    <section id="property-management" className="bg-background relative py-32">
      ...
      <div className="relative z-20 container mx-auto px-6">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <h2 className="text-foreground mb-8 font-serif text-5xl leading-none md:text-7xl">
              Asset <br />
              <span className="text-muted-foreground">Management</span>
            </h2>
            <p className="text-muted-foreground mb-8 max-w-md text-xl leading-relaxed">
            ...
            <Link
              href="#contact"
              className="group border-primary hover:text-primary text-foreground inline-flex items-center gap-2 border-b pb-1 transition-colors"
            >
              Request a Proposal
          ...
          <div className="grid gap-x-12 gap-y-8 sm:grid-cols-2">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="group border-border flex items-center gap-4 border-b pb-4"
              >
                ...
                <h3 className="text-muted-foreground group-hover:text-foreground font-serif text-xl transition-colors">
                  {feature}
                </h3>
              </motion.div>
            ))}
